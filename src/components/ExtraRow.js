...
function ExtraRow() {
  ...
  const [elmNum, setElmNum] = useState([1,2,3,4,5,6,7]);
  ...
  const changeTitle = (x) => {
    if (x !== gridNums.a) {
      ...
      let compSum = (slideLock.b ? 0 : gridNums.b) + ( slideLock.c ? 0 : gridNums.c )  + (slideLock.d ? 0 : gridNums.d) + (slideLock.e ? 0 : gridNums.e);
      //console.log(diff)
      ...
      let ndiff = (slideLock.e ? gridNums.e : gridNums.e - (gridNums.e / compSum) * diff);
      //console.log(x,gdiff,xdiff,sdiff,(x+gdiff+xdiff+sdiff))
      setGridNums({ ...gridNums, a: x, b: gdiff, c: xdiff, d: sdiff, e: ndiff });
    }
  };
  ...
  const changeGraph = (x) => {
    if (x !== gridNums.b) {
      ...
      let compSum = ( slideLock.a ? 0 : gridNums.a ) + ( slideLock.c ? 0 : gridNums.c )  + (slideLock.d ? 0 : gridNums.d) + (slideLock.e ? 0 : gridNums.e);
      //console.log(diff)
      ...
      let ndiff = (slideLock.e ? gridNums.e : gridNums.e - (gridNums.e / compSum) * diff);
      //console.log(x,gdiff,xdiff,sdiff,(x+gdiff+xdiff+sdiff))
      setGridNums({ ...gridNums, a: tdiff, b: x, c: xdiff, d: sdiff,  e: ndiff });
    }
  };
  ...
  const changeXaxis = (x) => {
    if (x !== gridNums.c) {
      ...
      let compSum = (slideLock.b ? 0 : gridNums.b) + (slideLock.a ? 0 : gridNums.a) + (slideLock.d ? 0 : gridNums.d) + (slideLock.e ? 0 : gridNums.e);
      //console.log(diff)
      let gdiff = (slideLock.b ? gridNums.b : gridNums.b - (gridNums.b / compSum) * diff);
      let tdiff = (slideLock.a ? gridNums.a : gridNums.a - (gridNums.a / compSum) * diff);
      let sdiff = (slideLock.d ? gridNums.d : gridNums.d - (gridNums.d / compSum) * diff);
      let ndiff = (slideLock.e ? gridNums.e : gridNums.e - (gridNums.e / compSum) * diff);
      //console.log(x,gdiff,xdiff,sdiff,(x+gdiff+xdiff+sdiff))
      setGridNums({ ...gridNums, a: tdiff, b: gdiff, c: x, d: sdiff, e: ndiff });
    }
  };
  ...
  const changeSource = (x) => {
    if (x !== gridNums.d) {
      ...
      let compSum = (slideLock.b ? 0 : gridNums.b) + ( slideLock.c ? 0 : gridNums.c ) + (slideLock.a ? 0 : gridNums.a) + (slideLock.e ? 0 : gridNums.e);
      //console.log(diff)
      let gdiff = (slideLock.b ? gridNums.b : gridNums.b - (gridNums.b / compSum) * diff);
      let xdiff = (slideLock.c ? gridNums.c : gridNums.c - (gridNums.c / compSum) * diff);
      let tdiff = (slideLock.a ? gridNums.a : gridNums.a - (gridNums.a / compSum) * diff);
      let ndiff = (slideLock.e ? gridNums.e : gridNums.e - (gridNums.e / compSum) * diff);
      //console.log(x,gdiff,xdiff,sdiff,(x+gdiff+xdiff+sdiff))
      setGridNums({ ...gridNums, a: tdiff, b: gdiff, c: xdiff, d: x, e: ndiff });
    }
  };
  ...
  const changeNewRow = (x) => {
    if (x !== gridNums.e) {
      ...
      let sdiff = (slideLock.d ? gridNums.d : gridNums.d - (gridNums.d / compSum) * diff);
      //console.log(x,gdiff,xdiff,sdiff,(x+gdiff+xdiff+sdiff))
      setGridNums({ ...gridNums, a: tdiff, b: gdiff, c: xdiff, d: sdiff, e: x });
    }
  };

  const changeYaxis = (x) => {
    let diff = x - gridNums.f;
    setGridNums({ ...gridNums, f: x, g: gridNums.g - diff });
  };
      ...
      {linkSubmit ? (
        <div className="container">
          <div className="img-comp">
            ...
            />
            <div
              className="grid-extraRow"
              id="grid"
              style={{
                gridTemplateRows: `${gridNums.a}% ${gridNums.e}% ${gridNums.b}% ${gridNums.c}% ${gridNums.d}%`,
                gridTemplateColumns: `${gridNums.f}% ${gridNums.g}%`,
              }}
            >
              <div className="title" id="title">
                Title
              </div>
              <div className="xAxisT" id="xAxisT">
                Top Box
              </div>
          ...
          <div className="slider-comp">
            ...
            <div className="slide-obj">
              <div className="slider-box">
                <p className="slider-tag">
                  Top X-Axis Height: {`${parseInt(gridNums.e)}%`}
                </p>
                <Slider
                  className="slider"
                  axis="x"
              ...
              <div className="lock-box">
                ...
                <input
                  type="checkbox"
                  defaultChecked={slideLock.e}
                  onChange={() => setSlideLock({ ...slideLock, e: !slideLock.e })}
                />
              </div>
            </div>
            <div className="slide-obj">
            ...
            <div className="slide-obj">
              <div className="slider-box">
                <p className="slider-tag">
                  Y-axis Width: {`${parseInt(gridNums.f)}%`}
                </p>
                <Slider
                  className="slider"
                  axis="x"
            ...
            <p className="slider-tag">
              Graph Width: {`${parseInt(gridNums.g)}%`}
            </p>
          </div>
        </div>
      ) : (
