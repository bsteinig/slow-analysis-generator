      ...
      {linkSubmit ? (
        <div className="container">
          <div className="img-comp">
            ...
            />
            <div
              className="grid-extraCol"
              id="grid"
              style={{
                gridTemplateRows: `${gridNums.a}% ${gridNums.b}% ${gridNums.c}% ${gridNums.d}%`,
                gridTemplateColumns: `${gridNums.e}% ${gridNums.f}% ${gridNums.g}%`,
              }}
            >
          ...
          <div className="slider-comp">
            ...
            <div className="slide-obj">
              ...
              <div className="lock-box">
                ...
                <input
                  type="checkbox"
                  defaultChecked={xLock.e}
                  onChange={() => setXLock({ ...xLock, e: !xLock.e })}
                />
              </div>
            </div>
            <div className="slide-obj">
              ...
              <div className="lock-box">
                ...
                <input
                  type="checkbox"
                  defaultChecked={xLock.f}
                  onChange={() => setXLock({ ...xLock, f: !xLock.f })}
                />
              </div>
            </div>
            <div className="slide-obj">
              <div className="slider-box">
                <p className="slider-tag">
                  Points Width: {`${parseInt(gridNums.g)}%`}
                </p>
                <Slider
                  className="slider"
                  axis="x"
              ...
              <div className="lock-box">
                ...
                <input
                  type="checkbox"
                  defaultChecked={xLock.g}
                  onChange={() => setXLock({ ...xLock, g: !xLock.g })}
                />
              </div>
            </div>
          </div>
